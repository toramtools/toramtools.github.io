...
const craftScroll = function (searchAny = false) {
    ...
    if (searchAny == true) {
        ...
        SCROLL_COMBINATIONS.forEach(function (scroll) {
            ...
            results += `<div class="combination-box" data-id="${weapons}"><div><img src="./media/images/${WEAPON_ICONS[weapons[0]]}.png"><img src="./media/images/${WEAPON_ICONS[weapons[1]]}.png"><img src="./media/images/${WEAPON_ICONS[weapons[2]]}.png"></div><div class="scroll-type">${skillList(scroll)}</div></div>\n`
        });
